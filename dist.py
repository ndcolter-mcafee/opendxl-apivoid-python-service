...
VERSION = __import__('dxlapivoidservice').get_version()
RELEASE_NAME = "dxlapivoidservice-python-dist-" + str(VERSION)
CONFIG_RELEASE_NAME = "dxlapivoidservice-python-dist-config-" + str(VERSION)
...
subprocess.check_call(["sphinx-apidoc",
                       ...
                       os.path.join(DIST_PY_FILE_LOCATION, "dxlapivoidservice")])
...
print("\nRemoving dxlapivoidservice.egg-info\n")
remove_tree(os.path.join(DIST_PY_FILE_LOCATION, "dxlapivoidservice.egg-info"))
