...
with open(os.path.join(CWD, "dxlapivoidservice", "_version.py")) as f:
...
class LintCommand(Command):
    ...
    def run(self):
        ...
        subprocess.check_call(["pylint", "dxlapivoidservice", "tests"] +
                              glob.glob("*.py"))
...
setup(
    ...
    # Keywords
    keywords=['opendxl', 'dxl', 'mcafee', 'service', 'apivoid', 'apivapi'],

    # Packages
    packages=[
        "dxlapivoidservice",
        "dxlapivoidservice._config",
        "dxlapivoidservice._config.sample",
        "dxlapivoidservice._config.app"],
    ...
    description="APIVoid DXL service library",
